...
### Prediccion de modelo - Naive Bayes
```{r}
test_prediction_naive_bayes <- predict(model_naive_bayes, newdata = test_set)
confusionMatrix(test_prediction_naive_bayes, test_set$economy)
```
## naive bayes - 0.698
