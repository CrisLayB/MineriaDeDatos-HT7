...
modelSVM_L01<-svm(economy~., data=train_set, cost=2^5, kernel="linear")
modelSVM_L02<-svm(economy~., data=train_set, cost=2^-5, kernel="linear")
modelSVM_L03<-svm(economy~., data=train_set, cost=0.5, kernel="linear")
modelSVM_R01<-svm(economy~., data=train_set, gamma=2^-5, kernel="radial")
modelSVM_R02<-svm(economy~., data=train_set, gamma=2^1, kernel="radial")
