...
```{r}
modelSVR_01 <- svm(salePrice~. - houseUtilities, data=train_set, type="eps-regression", kernel="linear", cost=14, epsilon=0.56)
...
rsquared <- 1 - (sum((test_set$salePrice - predictionReg01)^2) / sum((test_set$salePrice - mean(test_set$salePrice))^2))


cat("MSE:", mse, "\n")
cat("RMSE:", rmse, "\n")
cat("MAE:", mae, "\n")
cat("R cuadrado:", rsquared, "\n")
